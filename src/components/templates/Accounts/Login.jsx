    ...
    return (
        ...
        <div className='flex flex-col justify-center h-[700px]'>
          <div className='text-white text-center space-y-4 mb-8'>
            <h1 className='text-3xl md:text-5xl font-bold'>Log in with free trail</h1>
          ...
          <form action="#">
            <div className='flex flex-col items-center space-y-5 md:space-y-7'>
              <div className='text-white w-[80%] lg:w-[40%]'>
                ...
                <input type="text" placeholder='ex.email@domain.com' className='w-full h-full focus:outline-none focus:border-none text-black p-3 md:p-5 rounded-2xl bg-white' required />
              </div>
              <div className='text-white w-[80%] lg:w-[40%]'>
                <label htmlFor='#' className='block text-gray-300 mb-2'>Password*</label>
                <input type="password" placeholder='Enter password' className='w-full h-full focus:outline-none focus:border-none text-black p-3 md:p-5 rounded-2xl bg-white' required />
              </div>
            </div>
            ...
            <span className='text-center text-white'>Already have on account? <Link href="/register" className='text-blue-600'>register</Link></span> 
            </div>
