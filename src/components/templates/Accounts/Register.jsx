    ...
    return (
        ...
        <div className='flex flex-col justify-center h-[700px]'>
          <div className='text-white text-center space-y-4 mb-8'>
            <h1 className='text-3xl md:text-5xl font-bold'>Sign up with free trail</h1>
          ...
          <form action="#">
            <div className='flex flex-col items-center space-y-5 md:space-y-7'>
              ...
              <div className='text-white w-[80%] lg:w-[40%]'>
                <label htmlFor='#' className='block text-gray-300 mb-2'>Fullname</label>
                <input type="password" placeholder='Enter password' className='w-full h-full focus:outline-none focus:border-none text-black p-3 md:p-5 rounded-2xl bg-white' />
              </div>
              <div className='text-white w-[80%] lg:w-[40%]'>
