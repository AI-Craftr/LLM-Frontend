    ...
    return (
        <div className={`h-[100vh] flex m-auto scroll-smooth bg-black/30 fixed inset-0 w-full `}>
            ...
            <div className='text-white text-right px-3 pt-4 space-x-2 fixed right-0 text-sm'>
                ...
                <Link href="/register" className=' bg-black/30 border border-gray-700 hover:bg-gray-900 transition-all rounded-3xl cursor-pointer py-2 px-3 font-bold'>Sign up</Link>
            </div>
        </div>
    )
}
